...
class Indicator extends PanelMenu.Button {
    ...
    _init(targets) {
        ...
        this.add_child(this.discon_icon);
     ...
     */
    _update_icon(){
        let connected = this.update_connected();
        console.log(`Current state: ${connected}`);
        if(connected){
            this.remove_child(this.discon_icon);
            this.add_child(this.con_icon);
        } else {
            this.remove_child(this.con_icon);
            this.add_child(this.discon_icon);
        }
    }
    ...
    update_connected(){
        ...
        return connected;
        */
        return this.targets.some((target) => target.state);
    }
